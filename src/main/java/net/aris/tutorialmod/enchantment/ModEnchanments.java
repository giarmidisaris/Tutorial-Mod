package net.aris.tutorialmod.enchantment;

import net.aris.tutorialmod.TutorialMod;
import net.aris.tutorialmod.enchantment.custom.LightningStrikerEnchantmentEffect;
...
public class ModEnchanments {
    ...
    public static void bootstrap(Registerable<Enchantment> registerable){
        ...
        register(registerable, LIGHTNING_STRIKER,Enchantment.builder(Enchantment.definition(
                ...
                2,
                AttributeModifierSlot.MAINHAND)).exclusiveSet(enchantments.getOrThrow(EnchantmentTags.DAMAGE_EXCLUSIVE_SET))
