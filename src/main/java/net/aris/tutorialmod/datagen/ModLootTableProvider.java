...
import net.aris.tutorialmod.block.custom.CauliflowerCropBlock;
import net.aris.tutorialmod.block.custom.HoneyBerryBushBlock;
...
import static net.minecraft.loot.LootTable.*;
...
public class ModLootTableProvider extends FabricBlockLootTableProvider {
    ...
    public void generate() {
        ...
        addDrop(ModBlocks.DRIFTWOOD_LEAVES, leavesDrops(ModBlocks.DRIFTWOOD_LEAVES,ModBlocks.DRIFTWOOD_SAPLING,0.625f));
    }
    public Builder multipleOreDrops(Block drop, Item item, float minDrops, float maxDrops) {
        RegistryWrapper.Impl<Enchantment> impl = this.registryLookup.getWrapperOrThrow(RegistryKeys.ENCHANTMENT);
