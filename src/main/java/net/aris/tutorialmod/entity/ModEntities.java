package net.aris.tutorialmod.entity;

import net.aris.tutorialmod.TutorialMod;
import net.aris.tutorialmod.entity.custom.ChairEntity;
import net.aris.tutorialmod.entity.custom.MantisEntity;
import net.aris.tutorialmod.entity.custom.TomahawkProjectileEntity;
