package net.aris.tutorialmod.block.entity;

import net.aris.tutorialmod.TutorialMod;
import net.aris.tutorialmod.block.ModBlocks;
import net.aris.tutorialmod.block.entity.custom.GrowthChamberBlockEntity;
import net.aris.tutorialmod.block.entity.custom.PedestalBlockEntity;
