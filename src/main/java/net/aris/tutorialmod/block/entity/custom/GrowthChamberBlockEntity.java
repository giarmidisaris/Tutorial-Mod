package net.aris.tutorialmod.block.entity.custom;

import net.aris.tutorialmod.recipe.GrowthChamberRecipe;
import net.aris.tutorialmod.recipe.GrowthChamberRecipeInput;
import net.aris.tutorialmod.recipe.ModRecipes;
import net.fabricmc.fabric.api.screenhandler.v1.ExtendedScreenHandlerFactory;
import net.aris.tutorialmod.block.entity.ImplementedInventory;
