...
public class ModItems {
    ...
    public static final Item ARIS_SMITHING_TEMPLATE = registerItem("aris_armor_trim_smithing_template",
            SmithingTemplateItem.of(Identifier.of(TutorialMod.MOD_ID, "aris"), FeatureFlags.VANILLA));
